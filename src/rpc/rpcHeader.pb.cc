...
#include "../../include/rpc/rpcHeader.pb.h"
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpcHeader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::rpc::RpcHeader, servicename_),
  PROTOBUF_FIELD_OFFSET(::rpc::RpcHeader, methodname_),
  PROTOBUF_FIELD_OFFSET(::rpc::RpcHeader, argssize_),
};
...
const char descriptor_table_protodef_rpcHeader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcHeader.proto\022\003rpc\"F\n\tRpcHeader\022\023\n\013s"
  "erviceName\030\001 \001(\014\022\022\n\nmethodName\030\002 \001(\014\022\020\n\010"
  "argsSize\030\003 \001(\rb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpcHeader_2eproto = {
  false, false, descriptor_table_protodef_rpcHeader_2eproto, "rpcHeader.proto", 102,
